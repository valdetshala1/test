...
@Entity
public enum Merpillar implements PersistentEnum{

/** The pillar1. */
PILLAR1("MERPILLAR","PILLAR1","PR1",1,"Shtylla I","Pillar I","Stupac I"),

/** The pillar2. */
PILLAR2("MERPILLAR","PILLAR2","PR2",2,"Shtylla II","Pillar II","Stupac II"),

/** The pillar3. */
PILLAR3("MERPILLAR","PILLAR3","PR3",3,"Shtylla III","Pillar III","Stupac III");
 ...
 */
Merpillar(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Merpillar getDomain(String domKey) {
if(domKey.equals( "PR1")){
return PILLAR1;
}else if(domKey.equals("PR2")){
return PILLAR2;
}else{
return PILLAR3;
}}
