...
<body> 
<div id="export_stand_content">   		    
<form id="stand_export_form" class="form-horizontal" action="ExportStandSave.do" accept-charset="utf8" method="post"  enctype="multipart/form-data">
<!-- 					<br/> -->
<!-- 					<br/> -->
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('form').ajaxForm({
		    ...
		    success : function(data, status, jqXHR) {
				$("#export_stand_content").html(jqXHR.responseText);
				var errors = jqXHR.getResponseHeader("errors_exist");
				if(!errors){
					var url="StandExport.do?regionId="+$("#regionId").val()+"&muId="+$("#muId").val();
