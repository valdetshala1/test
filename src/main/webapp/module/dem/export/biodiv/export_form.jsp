...
<form id="biodiv_export_form" class="form-horizontal" action="ExportBiodivSave.do" accept-charset="utf8" method="post"  enctype="multipart/form-data">
<!-- 					<br/> -->
<!-- 					<br/> -->
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							...
							<button id="saveB" class="btn btn-primary ladda-button" type="submit" data-style="expand-right" data-color="green" data-size="medium" data-spinner-size="25" data-spinner-color="#ff0000">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('form').ajaxForm({
		    ...
		    success : function(data, status, jqXHR) {
				$("#export_biodiv_content").html(jqXHR.responseText);
				var errors = jqXHR.getResponseHeader("errors_exist");
				if(!errors){
					var url="BiodivExport.do?regionId="+$("#regionId").val()+"&muId="+$("#muId").val();
