...
@Entity
public enum Skill implements PersistentEnum{

/** The skills. */
SKILLS("SKILL","SKILLS","S",1,"Aftesit","Skills","Sposobnost"),

/** The education. */
EDUCATION("SKILL","EDUCATION","E",2,"Arsimimi","Education","Vaspitanje"),

/** The trainings. */
TRAININGS("SKILL","TRAININGS","T",3,"Trajnimet","Training","Treninzi"),

/** The certificate. */
CERTIFICATE("SKILL","CERTIFICATE","C",4,"Certifikimi","Certificate","Certifikacija");
 ...
 */
Skill(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Skill getDomain(String domKey) {
if(domKey.equals( "S")){
return SKILLS;
}else if(domKey.equals("E")){
return EDUCATION;
}else if(domKey.equals("T")){
return TRAININGS;
}else{
return CERTIFICATE;
}}
