 ...
 * 	Domain HrmannplanstatusUserType.
 */

public class HrmannplanstatusUserType extends PersistentEnumUserType<Hrmannplanstatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Hrmannplanstatus> returnedClass() {
return Hrmannplanstatus.class;
}
}
