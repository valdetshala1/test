 ...
 * 	Domain MinehazardUserType.
 */

public class MinehazardUserType extends PersistentEnumUserType<Minehazard>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Minehazard> returnedClass() {
return Minehazard.class;
}
}
