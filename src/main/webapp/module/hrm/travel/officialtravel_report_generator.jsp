...
$(document).ready(function() {
  ...
  $("#organisation").prop('required',true);
	$("#yearly").on('change',function(){
	  ...
	  $("#period1").prop('required',false);
	  $("#period2").prop('required',false);
	...
	$("#periodical").on('change',function(){
	  ...
	  $("#month").prop('required',false);
	  $("#period1").prop('required',true);
	  $("#period2").prop('required',true);
	...
	$("#cancelR").on('click', function(){
		$("#report_generator").dialog("close");
	});
	$("#generator").on('click', function () {
		if($("#organisationId").val()){
			var doc_name="";
			var doc_format=$('input[name=reportFormat]:checked').val();
			if($("#month").val() && $("#year").val() && $("#monthly").is(":checked")){
				//var link="hrm/travel/monthly_"+report_name+"travel_report.rptdesign";
				var link="\\hrm\\travel\\monthly_"+report_name+"travel_report.rptdesign";
				...
				//generateBIRTDoc(url);
			}else if($("#period1").val() && $("#period2").val() && $("#periodical").is(":checked")){
				//var link="hrm/travel/periodical_"+report_name+"travel_report.rptdesign";
				var link="\\hrm\\travel\\periodical_"+report_name+"travel_report.rptdesign";
				...
				downloadDoc("BirtReportGen.do", parameters);
				//generateBIRTDoc(url);
			}else if($("#year").val() && $("#yearly").is(":checked")){
				//var link="hrm/travel/yearly_"+report_name+"travel_report.rptdesign";
				var link="\\hrm\\travel\\yearly_"+report_name+"travel_report.rptdesign";
