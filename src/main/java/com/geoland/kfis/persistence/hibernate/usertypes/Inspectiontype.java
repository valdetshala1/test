...
@Entity
public enum Inspectiontype implements PersistentEnum{

/** The control. */
CONTROL("INSPECTIONTYPE","CONTROL","CTR",1,"Kontrolle","Control","Kontrola"),

/** The meeting. */
MEETING("INSPECTIONTYPE","MEETING","MTG",2,"Takim","Meeting","Sastanak"),

/** The seance. */
SEANCE("INSPECTIONTYPE","SEANCE","SNC",3,"Seance","Seance","Sednica"),

/** The decision. */
DECISION("INSPECTIONTYPE","DECISION","DCS",4,"Vendim","Decision","Odluka-rešenje");
...
/**
 * Instantiates a new inspectiontype.
 *
 ...
 */
Inspectiontype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Inspectiontype getDomain(String domKey) {
if(domKey.equals( "CTR")){
return CONTROL;
}else if(domKey.equals("MTG")){
return MEETING;
}else if(domKey.equals("SNC")){
return SEANCE;
}else{
return DECISION;
}}
