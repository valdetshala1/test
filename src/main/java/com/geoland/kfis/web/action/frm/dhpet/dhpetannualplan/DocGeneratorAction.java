 ...
 * @version 1.0
 * @created Dec 17, 2015, 3:41:25 PM
 */
public class DocGeneratorAction extends BaseActionSupport {
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getDhpetAnnualPlanDAO().get(docId);
	 ...
	 */
	public void setDoc(DhpetAnnualPlan doc) {
		this.doc = doc;
	}
