...
@Entity
public enum Periodtype implements PersistentEnum{

/** The month. */
MONTH("PERIODTYPE","MONTH","MO",1,"Muaj","Month","Month"),

/** The year. */
YEAR("PERIODTYPE","YEAR","YR",2,"Vit","Year","Year"),

/** The month3. */
MONTH3("PERIODTYPE","MONTH3","MT",1,"Tre mujorshë","Three Month","Three Month");
 ...
 */
Periodtype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Periodtype getDomain(String domKey) {
if(domKey.equals( "MO")){
return MONTH;
}else if (domKey.equals( "MR")){
return YEAR;
}else{
	return Periodtype.MONTH3;
}}
