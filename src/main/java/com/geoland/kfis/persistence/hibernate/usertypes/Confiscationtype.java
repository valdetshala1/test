...
@Entity
public enum Confiscationtype implements PersistentEnum{

/** The confiscation. */
CONFISCATION("CONFISCATIONTYPE","CONFISCATION","CO",1,"Konfiskim","Confiscation","Confiscation"),

/** The sale. */
SALE("CONFISCATIONTYPE","SALE","SA",2,"Shitje","Sale","Sale");
...
/**
 * Instantiates a new confiscationtype.
 *
 ...
 */
Confiscationtype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Confiscationtype getDomain(String domKey) {
if(domKey.equals( "CO")){
return CONFISCATION;
}else{
return SALE;
