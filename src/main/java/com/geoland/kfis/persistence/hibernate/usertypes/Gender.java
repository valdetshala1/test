...
/** The male. */
MALE("GENDER","MALE","M",1,"Mashkull","Male","Muško"),

/** The female. */
FEMALE("GENDER","FEMALE","F",2,"Femer","Female","Žensko");
 ...
 */
Gender(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Gender getDomain(String domKey) {
if(domKey.equals( "M")){
return MALE;
}else{
return FEMALE;
