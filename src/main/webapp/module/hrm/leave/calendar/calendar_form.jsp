...
<div class="row">
	<div class="col-xs-12 col-sm-7 col-md-7 col-lg-4">
		<h1 class="page-title txt-color-blueDark"><i class="fa fa-calendar fa-fw "></i> 
			...
			<span>
			<s:text name="leave.calendar.label.add.events"/>
			</span>
		</h1>
	</div>
</div>
		...
		<div class="well well-sm" id="event-container">
			<form>
				...
				<ul id='external-events' class="list-unstyled">
					<li>
						<span class="bg-color-darken txt-color-white" data-description="Currently busy" data-icon="fa-time">
						<s:text name="leave.calendar.label.office.meeting"/>
						</span>
					</li>
					<li>
						<span class="bg-color-blue txt-color-white" data-description="No Description" data-icon="fa-pie">
						<s:text name="leave.calendar.label.lunch.break"/></span>
					</li>
					<li>
						<span class="bg-color-red txt-color-white" data-description="Urgent Tasks" data-icon="fa-alert">
						<s:text name="leave.calendar.label.urgent"/></span>
					</li>
				</ul>
				<div class="checkbox">
					<label>
