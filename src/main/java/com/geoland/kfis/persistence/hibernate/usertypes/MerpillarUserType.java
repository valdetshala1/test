 ...
 * 	Domain MerpillarUserType.
 */

public class MerpillarUserType extends PersistentEnumUserType<Merpillar>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Merpillar> returnedClass() {
return Merpillar.class;
}
}
