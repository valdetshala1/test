...
@Entity
public enum Fueltype implements PersistentEnum{

/** The gasoline. */
GASOLINE("FUELTYPE","GASOLINE","GAS",1,"Benzine","Gasoline","Benzin"),

/** The diesel. */
DIESEL("FUELTYPE","DIESEL","DIE",2,"Nafte","Diesel","Nafta");
 ...
 */
Fueltype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Fueltype getDomain(String domKey) {
if(domKey.equals( "GAS")){
return GASOLINE;
}else{
return DIESEL;
}}
