...
/**
 * The Class EmployeeEducationSaveAction.
 *
 * @author ADELINA GASHI, GEO&LAND
 * @created May , 2014 10:22:18 AM
 * @Version 1.0
 */
public class EmployeeEducationSaveAction extends EmployeeSkillBaseAction {
	...
	public void validate() {
		...
		if(employeeSkill!=null && employeeSkill.getEducationType()==null){
				addFieldError("employeeSkill.educationType",getMessage("employee.education.type.empty"));
		}
	...
	public String execute() throws Exception {
		...
		if(file!=null){
			...
			employeeSkill.setDocSize(file.getTotalSpace());
		...
		employeeSkill.setSkillType(Skill.EDUCATION);
		employeeSkill.setCreatedDate(new Date());
		employeeSkill.setParty(createdBy);
		User user = getUser().getUser();
		employeeSkill.setCurrentUser(user);
