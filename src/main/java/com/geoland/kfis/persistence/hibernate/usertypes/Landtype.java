...
@Entity
public enum Landtype implements PersistentEnum{

/** The forestland. */
FORESTLAND("LANDTYPE","FORESTLAND","FL",1,"Tok� Pyjore","Forest Land","Forest land"),

/** The agricultureland. */
AGRICULTURELAND("LANDTYPE","AGRICULTURELAND","AL",2,"Tok� Bujq�sore","Agriculture Land","Agriculture Land"),

/** The watersurface. */
WATERSURFACE("LANDTYPE","WATERSURFACE","WS",3,"Sip�faqe Ujore","Water Surface","Water Surface");
 ...
 */
Landtype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Landtype getDomain(String domKey) {
if(domKey.equals( "FL")){
return FORESTLAND;
}else if(domKey.equals("AL")){
