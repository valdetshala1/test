 ...
 * 
 */
package com.geoland.kfis.web.action.ads.dp.docgenerator;
...
/**
 * The Class DocGeneratorAction.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 4:50:45 PM, Feb 24, 2015
 */
public class DocGeneratorAction extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -6253118107844675281L;
	
	/** The doc id. */
	private Long docId;
	
	/** The doc. */
	private DpMngmtAttach doc;
	...
	public String execute() throws Exception {
		...
		setContentType(doc.getDocContentType());
