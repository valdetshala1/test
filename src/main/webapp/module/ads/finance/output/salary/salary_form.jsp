...
<div>
	...
	<div class="widget-body">
		...
		<form id="salary_form" class="form-horizontal" action="FinOutputSalarySave.do" accept-charset="utf8" method="post">
			
			<fieldset>
				<legend><s:text name="output.salary.legend.salary"/></legend>
				<input id="financialOutput.id" name="financialOutput.id" value="<s:property value='financialOutput.id'/>" type="hidden">	
				<input id="financialOutput.outputType" name="financialOutput.outputType" value="<s:property value='salary.getDOMVALUE()'/>" type="hidden">	
				...
				<s:if test="fieldErrors.get('financialOutput.uopNumber')!=null">
					<div class="form-group has-error">
						...
						<div class="col-md-10">
							<input maxlength="50" id="financialOutput.uopNumber" name="financialOutput.uopNumber" class="form-control" placeholder="<s:text name="output.salary.legend.salary"/>" type="text">
				...
				<!-- START financialOutput.department  -->
				<s:if test="fieldErrors.get('financialOutput.organisation.id')!=null">
					<div class="form-group has-error">
						<label class="col-md-2 control-label" for="select-1">*<s:text name="output.salary.label.department"/></label>
						<div class="col-md-10">
							<input id="financialOutput.organisation.orgaName" name="financialOutput.organisation.orgaName" class="form-control" placeholder="<s:text name="output.salary.label.department"/>" type="text">
				...
				<s:else>
					<div class="form-group">
						<label class="col-md-2 control-label" for="select-1">*<s:text name="output.salary.label.department"/></label>
						<div class="col-md-10">
						<input id="financialOutput.organisation.orgaName" name="financialOutput.organisation.orgaName" value="<s:property value='financialOutput.organisation.orgaName'/>" class="form-control" placeholder="<s:text name="output.salary.label.department"/>" type="text">
						<input id="financialOutput.organisation.id" name="financialOutput.organisation.id" value="<s:property value='financialOutput.organisation.id'/>" type="hidden">
						</div>
					</div>
				</s:else>
				<!-- END financialOutput.department  -->	
					...
					<div class="form-group has-error">
						<label class="col-md-2 control-label">*<s:text name="finance.costs.label.expenditure.type"/></label>
							<div class="col-md-10">
								...
								<input id="financialOutput.financialType.id" name="financialOutput.financialType.id" class="form-control" type="hidden"/>
				...
				<s:else>
					<div class="form-group">
						<label class="col-md-2 control-label" >*<s:text name="finance.costs.label.expenditure.type"/></label>
						<div class="col-md-10">
							<input id="financialOutput.financialType.name" name="financialOutput.financialType.name" class="form-control" value="<s:property value='financialOutput.financialType.name'/>" placeholder="<s:text name="finance.costs.label.expenditure.type"/>"/>
							<input id="financialOutput.financialType.id" name="financialOutput.financialType.id" class="form-control" value="<s:property value='financialOutput.financialType.id'/>" type="hidden"/>
						</div>
					</div>
				</s:else>
				...
				<s:if test="fieldErrors.get('financialOutput.month')!=null">
					<div class="form-group has-error">
						<label class="col-md-2 control-label" for="select-1"><s:text name="output.salary.label.month"/></label>
						<div class="col-md-10">
							<select class="form-control" id="financialOutput.month" name="financialOutput.month">
							...
							<span class="help-block"><i class="fa fa-warning"></i>
								<s:property value="fieldErrors.get('financialOutput.month')"/>
							</span> 
						</div>
					</div>
				</s:if>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		if($("#financialOutput\\.organisation\\.id").val()){
			$("#financialOutput\\.organisation\\.orgaName").select2("data", {id: "<s:property value='financialOutput.organisation.id'/>", name: "<s:property value="financialOutput.organisation.orgaName"/>"+" ("+"<s:property value="financialOutput.organisation.operLevelVal"/>"+")"});
		}
		...
		$("#financialOutput\\.financialType\\.name").select2({
     	...
     	$("#financialOutput\\.financialType\\.name").select2("data", {id: "<s:property value='financialOutput.financialType.id'/>", name: "<s:property value='financialOutput.financialType.name'/>", code: "<s:property value='financialOutput.financialType.code'/>", describtion: "<s:property value='financialOutput.financialType.name'/>"});
    
			
		$("#cancel").on('click', function () {                    
			$.ajax({
				type : "GET",
				url : "FinOutput.salaryform.do", 
				async : false,
		...
		(function() {
			$('form').ajaxForm({
				...
				error : function(response, status, err){
					$("#salary_form_content").html(response);
					alert("error:" + errorThrown + ", status:" + status);
				},	    
