...
ui-grid{ width:100% !important; }
        ...
        $(document).ready(function () {
        	...
        	var in_grid=jQuery("#payslip_grid");
        	in_grid.jqGrid({
                ...
                rownumbers: true,
		   		...
		   		{name:'fiscal_year',index:'fiscal_year', width:'100%', align:"center",sortable:true,search:true},
		   		{name:'pay_month',index:'pay_month', width:'100%', align:"center",sortable:true,search:true},
    	   		...
    	   		{name:'createdDate',index:'createdDate', width:'100%', align:"center",sortable:false,search:false}
        	   		...
        	   		/*
        	   		{name:'employee.person.firstName',index:'employee.person.firstName', width:'100%', align:"center",sortable:false,formatter:"checkbox",search:false},
        	   		{name:'year',index:'year', width:'100%', align:"center",searchoptions:{sopt:['eq']}},
    			...
    			ondblClickRow: function(id, iRow, iCol, e) {
    				var selRow = jQuery(this).jqGrid('getGridParam','selrow');
	    				...
	    				var link = "Payslip.form.do?salaryId=" + rowData.salaryId;
	 					loadURL(link, $("#payslip_form_content"));
     	   			}
   				},
    		       ...
    		       jQuery("#"+subgrid_table_id).jqGrid({
    		          ...
    		          sortorder: "asc",
	 	   				...
	 	   				onSelectRow: function(ids) { 
	 	   					jQuery("#payslip_grid").resetSelection();
	 	   				}
    		       });
        	...
        	jQuery("#payslip_grid").jqGrid('filterToolbar',{searchOperators : true});
              	
        	jQuery("#payslip_grid").jqGrid('navGrid','#payslip_grid_pager',
                	{edit: false, add:false, del:false, refresh:true, view:false,search:false},
        			{}, {},{},{multipleSearch:true,recreateFilter:true});
        	jQuery("#payslip_grid").jqGrid ('navButtonAdd', '#pager', 
                	{ caption: "", buttonicon: "ui-icon-calculator", title: "choose columns",
                	onClickButton: function() {
                    	grid.jqGrid('columnChooser');
                	}})
                	.navButtonAdd('#payslip_grid_pager',{
             	   	   caption:"", 
	   		...
	   		*/
             	...
             	if(opl!='M'){  	
        			jQuery("#payslip_grid").navButtonAdd('#payslip_grid_pager',{
             	   	   caption:"", 
        ...
        $(window).bind('resize', function() {
            var width = $('#jqGrid_payslip_container').width();
            $('#payslip_grid').setGridWidth(width);
        });
...
<body>
		...
		<div style="margin-bottom: 1.0em;">
			...
			<div id="jqGrid_payslip_container">
				<table id="payslip_grid" class="scroll" cellpadding="0" cellspacing="0"></table> 
				<div id="payslip_grid_pager" class="scroll" style="text-align:center;"></div>
			</div>
