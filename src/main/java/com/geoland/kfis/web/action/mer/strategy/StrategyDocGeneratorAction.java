...
/**
 * The Class StrategyDocGeneratorAction.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 11:47:33 AM, Mar 30, 2015
 */
public class StrategyDocGeneratorAction extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 4340532385255995663L;

	/** The doc id. */
	private Long docId;
	
	/** The doc. */
	private MerStrategyDoc doc;
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getMerStrategyDocDAO().get(docId);
