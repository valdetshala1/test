...
@Entity
public enum Origin implements PersistentEnum{

/** The publicforest. */
PUBLICFOREST("ORIGIN","PUBLICFOREST","PU",1,"Pyje Publike","Public Forest","Javne Å¡ume"),

/** The privateforest. */
PRIVATEFOREST("ORIGIN","PRIVATEFOREST","PR",2,"Pyje Private","Privat Forest","Privatne Å¡ume");
 ...
 */
Origin(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Origin getDomain(String domKey) {
if(domKey.equals( "PU")){
return PUBLICFOREST;
}else{
