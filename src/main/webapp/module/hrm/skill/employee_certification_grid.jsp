...
<body>
	<div id="employee_certification_grid_content" class="custom-scroll table-responsive"
		style="height: 290px; overflow-y: scroll;">
		<table class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					<th></th>
					<th><s:text name="hrm.skill.grid.certification"/></th>
			...
			<tbody>
				<s:iterator value="employeeCertificationList">
					<tr>
						<td>
							<div class="btn-group btn-group-xs">
								<button class="btn btn-primary btn-xs" rel="tooltip"
									...
									onclick="editCertificationButton(this)">
	...
	<div class="form-actions">
		<div class="row">
			<div class="col-md-12">
				<button id="addCertificationButton" class="btn btn-primary"
					type="submit">
...
function editCertificationButton(objButton){
	var link = "EmployeeSkill.certification.do?skillId=" + objButton.value;
	openDialogForm('employee_certification_form_content',link,"<s:text name="employee.certification"/>",800,550);
	return false;
};
$(document).ready(function () {
	$("#addCertificationButton").on('click', function() {
		$("#addCertificationButton").prop('disabled','disabled');
		var link= "EmployeeSkill.certification.do";
		openDialogForm('employee_certification_form_content',link,"<s:text name="employee.certification"/>",800,550);
		return false;
	});
});
