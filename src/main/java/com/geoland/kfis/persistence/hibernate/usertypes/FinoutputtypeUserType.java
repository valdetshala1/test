 ...
 * 	Domain FinoutputtypeUserType.
 */

public class FinoutputtypeUserType extends PersistentEnumUserType<Finoutputtype>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Finoutputtype> returnedClass() {
return Finoutputtype.class;
}
}
