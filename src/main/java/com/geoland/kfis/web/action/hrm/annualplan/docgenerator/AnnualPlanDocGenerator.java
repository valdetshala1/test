package com.geoland.kfis.web.action.hrm.annualplan.docgenerator;
...
/**
 * The Class AnnualPlanDocGenerator.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 3:00:34 PM, Jun 2, 2015
 */
public class AnnualPlanDocGenerator extends BaseActionSupport {
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getHrmAnnualPlanDocDAO().get(docId);
