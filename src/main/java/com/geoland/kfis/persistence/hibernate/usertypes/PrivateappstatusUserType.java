 ...
 * 	Domain PrivateappstatusUserType.
 */

public class PrivateappstatusUserType extends PersistentEnumUserType<Privateappstatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Privateappstatus> returnedClass() {
return Privateappstatus.class;
}
}
