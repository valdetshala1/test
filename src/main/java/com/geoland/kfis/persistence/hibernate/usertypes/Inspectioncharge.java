...
@Entity
public enum Inspectioncharge implements PersistentEnum{

/** The penal. */
PENAL("INSPECTIONCHARGE","PENAL","P",1,"Penale","Penal","Krivično"),

/** The offender. */
OFFENDER("INSPECTIONCHARGE","OFFENDER","O",1,"Kundervajtes","Offender","Prekršajno");
...
/**
 * Instantiates a new inspectioncharge.
 *
 ...
 */
Inspectioncharge(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Inspectioncharge getDomain(String domKey) {
if(domKey.equals( "P")){
return PENAL;
}else{
return OFFENDER;
