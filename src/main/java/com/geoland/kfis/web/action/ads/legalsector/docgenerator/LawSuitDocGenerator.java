 ...
 * 
 */
package com.geoland.kfis.web.action.ads.legalsector.docgenerator;
...
/**
 * The Class LawSuitDocGenerator.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 1:55:28 PM, Jan 12, 2015
 */
public class LawSuitDocGenerator extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -237374469625665814L;
	
	/** The attachment id. */
	protected Long attachmentId;
	
	/** The attachment. */
	protected LawSuitStatus attachment;
	...
	public void validate() {
		if(attachmentId!=null){
			attachment=DAOFactory.getFactory().getLawsuitStatusDAO().get(attachmentId);
	 ...
	 */
	public LawSuitStatus getAttachment() {
		return attachment;
	}
	 ...
	 */
	public void setAttachment(LawSuitStatus attachment) {
