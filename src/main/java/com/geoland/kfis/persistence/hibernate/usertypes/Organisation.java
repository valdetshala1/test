...
@Entity
public enum Organisation implements PersistentEnum{

/** The organisation. */
ORGANISATION("ORGANISATION","ORGANISATION","O",1,"Organizata","Organisation","Organizacija"),

/** The division. */
DIVISION("ORGANISATION","DIVISION","V",2,"Divizioni","Division","Divizija"),

/** The department. */
DEPARTMENT("ORGANISATION","DEPARTMENT","D",3,"Departamenti","Department","Departman"),

/** The sector. */
SECTOR("ORGANISATION","SECTOR","D",4,"Sektori","Sector","Sektor");
 ...
 */
Organisation(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Organisation getDomain(String domKey) {
if(domKey.equals( "O")){
return ORGANISATION;
