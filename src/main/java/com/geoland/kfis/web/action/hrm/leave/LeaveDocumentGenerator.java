...
/**
 * The Class LeaveDocumentGenerator.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 3:04:24 PM, Jan 5, 2015
 */
public class LeaveDocumentGenerator extends LeaveBaseAction {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5996875406008183387L;
	
	/** The attachment id. */
	protected Long attachmentId;
	
	/** The attachment. */
	protected Leave attachment;
	...
	public void validate() {
		if(attachmentId!=null){
			attachment=DAOFactory.getFactory().getLeaveDAO().get(attachmentId);
	 ...
	 */
	public void setAttachment(Leave attachment) {
