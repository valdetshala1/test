...
@Entity
public enum Finoutputtype implements PersistentEnum{

/** The salary. */
SALARY("FINOUTPUTTYPE","SALARY","S",1,"Pagesa","Salarys","Uplata"),

/** The costs. */
COSTS("FINOUTPUTTYPE","COSTS","C",2,"Shpenzime","Costs","Utrošci");
...
/**
 * Instantiates a new finoutputtype.
 *
 ...
 */
Finoutputtype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Finoutputtype getDomain(String domKey) {
if(domKey.equals( "S")){
return SALARY;
}else{
return COSTS;
