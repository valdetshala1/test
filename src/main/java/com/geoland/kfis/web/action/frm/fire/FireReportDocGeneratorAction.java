...
/**
 * The Class FireReportDocGeneratorAction.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 1:31:08 PM, May 20, 2015
 */
public class FireReportDocGeneratorAction extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7656684807187745162L;
	
	/** The doc id. */
	private Long docId;
	
	/** The doc. */
	private FireReport doc;
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getFireReportDAO().get(docId);
	 ...
	 */
	public void setDoc(FireReport doc) {
		this.doc = doc;
	}
