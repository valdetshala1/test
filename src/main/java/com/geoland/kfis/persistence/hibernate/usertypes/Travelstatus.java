...
@Entity
public enum Travelstatus implements PersistentEnum{

/** The approved. */
APPROVED("TRAVELSTATUS","APPROVED","A",1,"E aprovuar","Approved","Usvojeno"),

/** The pending. */
PENDING("TRAVELSTATUS","PENDING","P",2,"Ne pritje","Pending","Na čekanje"),

/** The rejected. */
REJECTED("TRAVELSTATUS","REJECTED","R",3,"E refuzuar","Rejected","Odbijeno");
...
/**
 * Instantiates a new travelstatus.
 *
 ...
 */
Travelstatus(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Travelstatus getDomain(String domKey) {
if(domKey.equals( "A")){
return APPROVED;
}else if(domKey.equals("P")){
return PENDING;
}else{
return REJECTED;
}}
