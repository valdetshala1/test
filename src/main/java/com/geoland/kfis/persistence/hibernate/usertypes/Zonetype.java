...
@Entity
public enum Zonetype implements PersistentEnum{

/** The touristobjects. */
TOURISTOBJECTS("ZONETYPE","TOURISTOBJECTS","TO",1,"Objekt turistik","Tourist object","Tourist object"),

/** The dangerouszone. */
DANGEROUSZONE("ZONETYPE","DANGEROUSZONE","DZ",2,"Zone e rrezikshme","Dangerous zone","Dangerous zone"),

/** The visitedareas. */
VISITEDAREAS("ZONETYPE","VISITEDAREAS","VA",3,"Zona te vizituara","Visited areas","Visited areas");
 ...
 */
Zonetype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
...
if(this == TOURISTOBJECTS){
return "TO";
}else if(this == DANGEROUSZONE){
return "DZ";
}else{
return "VA";
}}
 ...
 * @return the domain
 */
public static Zonetype getDomain(String domKey) {
if(domKey.equals( "TO")){
return TOURISTOBJECTS;
}else if(domKey.equals("DZ")){
