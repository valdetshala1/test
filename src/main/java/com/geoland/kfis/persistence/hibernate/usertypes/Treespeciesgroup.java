...
@Entity
public enum Treespeciesgroup implements PersistentEnum{

/** The conifers. */
CONIFERS("TREESPECIESGROUP","CONIFERS","CON",1,"Halor","Conifers","Çetinar"),

/** The broadleaves. */
BROADLEAVES("TREESPECIESGROUP","BROADLEAVES","BRO",2,"Fletor","Broadleaves","Lišćar");
...
/**
 * Instantiates a new treespeciesgroup.
 *
 ...
 */
Treespeciesgroup(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Treespeciesgroup getDomain(String domKey) {
if(domKey.equals( "CON")){
return CONIFERS;
}else{
return BROADLEAVES;
}}
