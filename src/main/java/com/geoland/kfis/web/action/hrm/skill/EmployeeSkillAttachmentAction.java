...
/**
 * The Class EmployeeSkillAttachmentAction.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 9:32:02 AM, Nov 14, 2014
 */
public class EmployeeSkillAttachmentAction extends EmployeeSkillBaseAction {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = -4648398534019101411L;
	
	/** The attachment id. */
	private Long attachmentId;
	
	/** The attachment. */
	private EmployeeSkill attachment;
	...
	public void validate() {
		if(attachmentId!=null){
			attachment=DAOFactory.getFactory().getEmployeeSkillDAO().get(attachmentId);
	 ...
	 */
	public EmployeeSkill getAttachment() {
		return attachment;
	}
	 ...
	 */
	public void setAttachment(EmployeeSkill attachment) {
