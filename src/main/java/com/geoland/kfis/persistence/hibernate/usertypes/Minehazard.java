...
@Entity
public enum Minehazard implements PersistentEnum{

/** The Yes. */
Yes("MINEHAZARD","Yes","Yes",1,"Po","Yes","Yes"),

/** The No. */
No("MINEHAZARD","No","No",2,"Jo","No","No");
 ...
 */
Minehazard(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Minehazard getDomain(String domKey) {
if(domKey.equals( "Yes")){
return Yes;
}else{
return No;
}}
