 ...
 * 	Domain OperationlevelUserType.
 */

public class OperationlevelUserType extends PersistentEnumUserType<Operationlevel>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Operationlevel> returnedClass() {
return Operationlevel.class;
}
}
