 ...
 * 	Domain InspectionchargeUserType.
 */

public class InspectionchargeUserType extends PersistentEnumUserType<Inspectioncharge>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Inspectioncharge> returnedClass() {
return Inspectioncharge.class;
}
}
