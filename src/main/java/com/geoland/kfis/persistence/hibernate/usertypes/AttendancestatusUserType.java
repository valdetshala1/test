 ...
 * 	Domain AttendancestatusUserType.
 */

public class AttendancestatusUserType extends PersistentEnumUserType<Attendancestatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Attendancestatus> returnedClass() {
