...
@Entity
public enum Partyrole implements PersistentEnum{

/** The forestowner. */
FORESTOWNER("PARTYROLE","FORESTOWNER","FRO",1,"Pronar i pyjeve","Forest owner","Vlasnik šuma");
 ...
 */
Partyrole(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Partyrole getDomain(String domKey) {
if(domKey.equals( "FRO")){
return FORESTOWNER;
}
return null;
}
