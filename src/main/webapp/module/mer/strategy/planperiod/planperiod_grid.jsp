        	...
        	$grid = jQuery("#planperiod_grid").jqGrid({
        		...
        		gridComplete: function(){
        			...
        			for(var i=0;i < ids.length;i++){
        				var cl = ids[i];
        					au = "<button class='btn btn-xs btn-default' data-original-title='Edit Row' title='<s:text name="audit.title"/>' onclick=\"showHistory('MerPlanPeriod','#planperiod_grid', '"+cl+"');\"><i class='fa fa-history'></i></button>";	
    			...
    			ondblClickRow: function(id, iRow, iCol, e) {
    				...
    				var link = "PlanPeriod.form.do?periodId=" + rowData.id;
