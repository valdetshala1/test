 ...
 * 	Domain ActivitystatusUserType.
 */

public class ActivitystatusUserType extends PersistentEnumUserType<Activitystatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Activitystatus> returnedClass() {
