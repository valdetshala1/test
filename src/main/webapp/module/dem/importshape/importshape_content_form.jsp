...
<body>    		    
<div id="shape_import_form_content">
<form id="shape_import_form" class="form-horizontal" action="ImportShapeSave.do" accept-charset="utf8" method="post"  enctype="multipart/form-data">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$('form').ajaxForm({
		    ...
		    success : function(data, status, jqXHR) {
				$("#shape_import_form_content").html(jqXHR.responseText);
