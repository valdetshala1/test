 ...
 * 
 */
package com.geoland.kfis.web.action.frm.inspectionoffice.docgenerator;
...
/**
 * The Class InspectionDocGenerator.
 *
 * @author Adelina Gashi , GEO&LAND
 * @version 1.0
 * @created Mar 3, 2015 , 1:50:41 PM
 */
public class InspectionDocGenerator extends BaseActionSupport {
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getInspectionDocDAO().get(docId);
