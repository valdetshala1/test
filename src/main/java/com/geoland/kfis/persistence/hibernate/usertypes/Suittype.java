...
@Entity
public enum Suittype implements PersistentEnum{

/** The civil. */
CIVIL("SUITTYPE","CIVIL","CV",1,"Civile","Civil","Civilno"),

/** The penal. */
PENAL("SUITTYPE","PENAL","PE",2,"Penale","Penal","Krivično"),

/** The offender. */
OFFENDER("SUITTYPE","OFFENDER","OF",3,"Kundervajtes","Offender","Prekršajnog");
 ...
 */
Suittype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Suittype getDomain(String domKey) {
if(domKey.equals( "CV")){
return CIVIL;
}else if(domKey.equals("PE")){
return PENAL;
}else{
return OFFENDER;
}}
