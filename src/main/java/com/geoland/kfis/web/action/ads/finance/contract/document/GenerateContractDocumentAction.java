 ...
 * 
 */
package com.geoland.kfis.web.action.ads.finance.contract.document;
...
/**
 * The Class GenerateContractDocumentAction.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 9:30:51 AM, Nov 18, 2014
 */
public class GenerateContractDocumentAction extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 7449829622762198922L;

	/** The doc id. */
	private Long docId;
	
	/** The doc. */
	private ContractDoc doc;
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getContractDocDAO().get(docId);
