					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<div class="input-group date">
		                    	<input type='text' id="startCommitmentDate" name="startCommitmentDate"  class="form-control" placeholder="<s:text name='hrm.skill.label.end.date'/>" />
...
$(document).ready(function() {
	...
	$("#generateReport").on('click', function () {
		...
		if($("#month").val()){
			...
			// openBirtViewer("ads/finance/output/salary/month_report.rptdesign", parameters);
				...
				//openBirtViewer("ads/finance/output/salary/commitment_date_report.rptdesign", parameters);
				}else{
