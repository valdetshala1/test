 ...
 * 
 */
package com.geoland.kfis.web.action.frm.annualplan.docgenerator;
...
/**
 * The Class ActivityStatusDocGenerator.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 10:29:18 AM, Jan 8, 2015
 */
public class ActivityStatusDocGenerator extends BaseActionSupport {
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getActivityStatusDocDAO().get(docId);
