 ...
 * 	Domain ForesttypeUserType.
 */

public class ForesttypeUserType extends PersistentEnumUserType<Foresttype>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Foresttype> returnedClass() {
return Foresttype.class;
}
}
