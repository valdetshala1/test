 ...
 * 	Domain ProtenderstatusUserType.
 */

public class ProtenderstatusUserType extends PersistentEnumUserType<Protenderstatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Protenderstatus> returnedClass() {
return Protenderstatus.class;
}
}
