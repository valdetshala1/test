...
/**
 * 	Domain generated Mon Oct 23 15:28:08 CEST 2017.
 */

@Entity
public enum Linetempstatus implements PersistentEnum{

/** The imported. */
IMPORTED("LINETEMPSTATUS","IMPORTED","IM",1,"Importuar","Imported","Imported"),

/** The used. */
USED("LINETEMPSTATUS","USED","US",2,"Shqyrtuar","Used","Used"),

/** The deleted. */
DELETED("LINETEMPSTATUS","DELETED","DL",3,"I fshirë","Deleted","Deleted");
...
/**
 * Instantiates a new linetempstatus.
 *
 ...
 */
Linetempstatus(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Linetempstatus getDomain(String domKey) {
if(domKey.equals( "IM")){
return IMPORTED;
}else if(domKey.equals("US")){
return USED;
}else{
return DELETED;
}}
