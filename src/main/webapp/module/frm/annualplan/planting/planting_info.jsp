...
<div id="container">
	<div class="widget-body">
			<h3><s:text name="annual.plan.un.submited.activities.Planting"/> Info</h3>
			<s:if test="plaAct != null">
			<table border="1" cellpadding="0" > 
						...
						<table border="1" width="400px">
							<th class="headInfo">
								...
								<s:text name="frm.stand.compartment"/>	/  <s:text name="frm.stand.stand"/>: &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
									<b><s:property value="plaAct[0].stand.compartment.compNr"/> / <s:property value="plaAct[0].stand.standNr"/></b>
								</div>
							</th>
						</table>
						</div>
				...
				<tr> 					
					...
					<th class="bodyInfo" style="width: 154px;"><div class="infocontent10b" ><s:text name="frm.protection.plan.value"></s:text></div></th>
					<th class="bodyInfo"><div class="infocontent10b"><s:text name="frm.protection.impl.value"></s:text></div></th>
				</tr>
				<tr>
					<table border="1" cellpadding="0" > 
						<tr>
								...
								<div class="infocontent10">
										<table border="1" width="400px">
												<tr> 
													...
													<th class="bodyInfo"><div class="infocontent10b"><s:text name="planting.stand.planned.area">(ha)</s:text></div></th>
													<th class="bodyInfo"><div class="infocontent10b"><s:text name="planting.stand.planned.trees"></s:text></div></th>
													<th class="bodyInfo"><div class="infocontent10b"><s:text name="planting.stand.planned.area">(ha)</s:text></div></th>
													<th class="bodyInfo"><div class="infocontent10b"><s:text name="planting.stand.planned.trees"></s:text></div></th>
												</tr>
												<s:iterator value="plaAct" var="a">
													<tr>
														<td class="bodyInfo">
														...
														<td class="bodyInfo"><div class="infocontent10b"><s:property value="#a.getImTrees()" /></div></td>
