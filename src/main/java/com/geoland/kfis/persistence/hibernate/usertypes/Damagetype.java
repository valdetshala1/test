...
@Entity
public enum Damagetype implements PersistentEnum{

/** The felling. */
FELLING("DAMAGETYPE","FELLING","FE",1,"Prerje","Felling","Seča"),

/** The transport. */
TRANSPORT("DAMAGETYPE","TRANSPORT","TR",2,"Transport","Transport","Transport");
 ...
 */
Damagetype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Damagetype getDomain(String domKey) {
if(domKey.equals( "FE")){
return FELLING;
}else{
return TRANSPORT;
