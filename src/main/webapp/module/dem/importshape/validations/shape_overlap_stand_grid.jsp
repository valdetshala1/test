...
ui-grid{ width:100% !important; }
        ...
        $(document).ready(function () {
        	jQuery("#shape_overlap_stand").jqGrid({
//         	   	url:'DemGrid.shapeOverlapStand.do',	
        	   	url:'',	
        	   	mtype: 'GET',
        		datatype: "json",
        		jsonReader : {
                ...
                rownumbers: true,
                cmTemplate: {sortable:false},
        	   	colNames:['fmr','mu','comp','stand','stand_id','comp_b','stand_b','stand_id_b','count_part','area'],
        	   	colModel:[
        	   	...
        	   	rowNum:10,
        	   	rowList:[10,20,30],
        	   	pager: '#shape_overlap_stand_pager',
        	   	sortname: 'stand_id',
        	    viewrecords: true,
        	    sortorder: "desc",
        		multiselect: false,
        		...
        		gridComplete: function(){
        			var gridLength = jQuery("#shape_overlap_stand").jqGrid('getDataIDs').length;
        			if(gridLength>0){
        				$("#shape_overlap_stand_grid_content").show();
        				$("#step_3").css("background","#D84C4C");
        				$("#import_shape_content").hide();
        				window.open("ImportValidations.do?validationType=C&validationNumber=3",'_blank');
//     	 				$.ajax({
// 	   					    type : "GET",
...
//    					   });
    					$.smallBox({
        					...
        					jQuery("#shape_overlap_stand_gis").jqGrid('setGridParam', {url:"DemGrid.shapeOverlapStandGIS.do"});
        		            jQuery("#shape_overlap_stand_gis").trigger('reloadGrid');	
                		}
            	},
        	});
              	
        	jQuery("#shape_overlap_stand").jqGrid('navGrid','#shape_overlap_stand_pager',
        ...
        $(window).bind('resize', function() {
            var width = $('#jqGrid_shape_overlap_stand_container').width();
            $('#shape_overlap_stand').setGridWidth(width);
        });
...
<body>
		...
		<div style="margin-bottom: 1.0em;">
			...
			<div id="jqGrid_shape_overlap_stand_container">
				<table id="shape_overlap_stand" class="scroll"></table> 
				<div id="shape_overlap_stand_pager" class="scroll" style="text-align:center;"></div>
			</div>
		</div>
		<!-- end widget div -->
