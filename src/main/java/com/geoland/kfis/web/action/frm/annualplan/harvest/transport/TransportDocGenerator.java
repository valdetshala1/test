...
/**
 * The Class TransportDocGenerator.
 *
 * @author Adelina Gashi, GEO&LAND
 * @version 1.0
 * @created 11:47:11 AM Jan 14, 2016
 */
public class TransportDocGenerator extends BaseActionSupport {
	...
	/** The doc. */
	private StandHarvestImplTransport doc;
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getStandHarvestImplTransportDAO().get(docId);
