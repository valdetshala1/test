...
@Entity
public enum Financialtype implements PersistentEnum{

/** The input. */
INPUT("FINANCIALTYPE","INPUT","IN",1,"Hyrje","Input","Ulaz"),

/** The output. */
OUTPUT("FINANCIALTYPE","OUTPUT","OU",2,"Dalje","Output","Izlaz");
...
/**
 * Instantiates a new financialtype.
 *
 ...
 */
Financialtype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Financialtype getDomain(String domKey) {
if(domKey.equals( "IN")){
return INPUT;
}else{
return OUTPUT;
