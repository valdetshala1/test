        ...
        function onModificationEnd(feature) {
        	...
        	if($geometry){
        		var polygonFeature = wkt.read(wkt_obj);
             	...
             	if(text=="false"){
             		$.SmartMessageBox({
    					title : "<i class='fa fa-sign-out txt-color-orangeDark'></i> Overlaped <span class='txt-color-orangeDark'><strong> </strong></span> ?",
...
//            });
                ...
                map_a.addLayers([openstreetmap, /* google_maps, google_satellite, google_terrain, */orto, vectorLayer, pedolo, mu, compartments, stand,biodiv, plots,fmr]);
