...
<div id="page_slv_content">
	...
	<!-- start tabs definition -->
      <div class="col-sm-12">
		       <div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-1" data-widget-editbutton="false" data-widget-deletebutton="false"  data-widget-collapsed="true">
		       	<header>
				...
				<div>  
					<div class="widget-body no-padding">
						<jsp:include page="map_search_form.jsp"></jsp:include>						
					</div>
				</div>
			</div>
		</div>
      ...
      <div class="col-sm-12">
     		<div class="jarviswidget jarviswidget-color-blueLight" id="wid-id-2" data-widget-editbutton="false" data-widget-deletebutton="false" data-widget-collapsed="true">
			    <header>
					<span class="widget-icon"> <i class="fa fa-map-marker"></i> </span>
					<h2>Harta</h2>	
				</header>
				<div>
					<div class="widget-body no-padding">
						...
						<div class="widget-body">
								...
								<a  id="printPopup"  class="widget-toolbar  pull-left no-border" title="<s:text name="frm.print.map.form"/>">
									<i class="fa fa-print"></i>
								</a>
								
								<a  id="detailPopup"  class="widget-toolbar  pull-left no-border" title="<s:text name="frm.parcel.det.title"/>">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#detailPopup").on("click",function(){
			var link = "SearchMapAction.parcel_detail.do";
			openDialogForm('parcel_detail_page_content',link,"<s:text name="frm.parcel.det.title"/>",600,700);
		});
