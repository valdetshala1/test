 ...
 * 	Domain MerstrategystatusUserType.
 */

public class MerstrategystatusUserType extends PersistentEnumUserType<Merstrategystatus>{

/* (non-Javadoc)
 * @see com.geoland.framework.persistence.hibernate.PersistentEnumUserType#returnedClass()
 */
@Override
public Class<Merstrategystatus> returnedClass() {
return Merstrategystatus.class;
}
}
