package com.geoland.kfis.web.action.ads.finance.input.docgenerator;
...
/**
 * The Class FinInputDocGenerator.
 *
 * @author Festim Krasniqi, GEO&LAND
 * @version 1.0
 * @created 3:19:19 PM, Jun 4, 2015
 */
public class FinInputDocGenerator extends BaseActionSupport {

	/** The Constant serialVersionUID. */
	private static final long serialVersionUID = 5834272095495678697L;
	
	/** The doc id. */
	private Long docId;
	
	/** The doc. */
	private FinInputStatus doc;
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getFinInputStatusDAO().get(docId);
	 ...
	 */
	public void setDoc(FinInputStatus doc) {
		this.doc = doc;
	}
}
