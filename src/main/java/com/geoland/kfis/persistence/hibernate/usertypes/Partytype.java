...
@Entity
public enum Partytype implements PersistentEnum{

/** The person. */
PERSON("PARTYTYPE","PERSON","P",1,"Person","Person","Lice"),

/** The organisation. */
ORGANISATION("PARTYTYPE","ORGANISATION","O",2,"Organizat","Organisation","Organizacija");
 ...
 */
Partytype(String DOMNAME, String DOMVALUE, String DOMKEY, Integer SORT, String DOMTEXT, String DOMTEXT_EN, String DOMTEXT_SR){
 ...
 * @return the domain
 */
public static Partytype getDomain(String domKey) {
if(domKey.equals( "P")){
return PERSON;
}else{
return ORGANISATION;
