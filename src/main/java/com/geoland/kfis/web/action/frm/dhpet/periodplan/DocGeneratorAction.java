...
public class DocGeneratorAction extends BaseActionSupport {
	...
	public void validate() {
		if(docId!=null){
			doc=DAOFactory.getFactory().getDhpetPeriodPlanDAO().get(docId);
	 ...
	 */
	public void setDoc(DhpetPeriodPlan doc) {
		this.doc = doc;
	}
